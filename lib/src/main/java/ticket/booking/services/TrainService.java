...
private boolean validTrain(Train train, String source, String destination){
    return train.getStations().contains(source) && train.getStations().contains(destination) && train.getStations().indexOf(source) < train.getStations().indexOf(destination);
}
/*               OR
